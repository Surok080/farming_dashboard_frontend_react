            ...
            <Box display={"flex"}>
              ...
              >
                ...
                <Typography
                  ...
                  variant="h5"
                >
                  {data.budget.other_expenses.toFixed(2)}
                </Typography>
              </Box>
            </Box>
            <Box display={"flex"}>
              ...
              >
                ...
                <Typography
                  ...
                  variant="h5"
                >
                  {data.budget.fertilizers.toFixed(2)}
                </Typography>
              </Box>
              <Box
                width={"50%"}
              ...
              >
                ...
                <Typography
                  ...
                  variant="h5"
                >
                  {data.budget.products.toFixed(2)}
                </Typography>
              </Box>
            </Box>
          </Box>
