...
const RightBlockPlanFactV2 = ({ dashboardData, selectedCultures, selectedFields, year, planType }) => {
  ...
  const materialCostsData = dashboardData?.materials ? [
    { category: "Семена", plan: dashboardData.materials.seeds.plan, fact: dashboardData.materials.seeds.fact, percentage: dashboardData.materials.seeds.percent },
    { category: "Удобрения", plan: dashboardData.materials.fertilizers.plan, fact: dashboardData.materials.fertilizers.fact, percentage: dashboardData.materials.fertilizers.percent },
    { category: "СХЗР", plan: dashboardData.materials.shzr.plan, fact: dashboardData.materials.shzr.fact, percentage: dashboardData.materials.shzr.percent },
    { category: "ГСМ", plan: dashboardData.materials.fuel.plan, fact: dashboardData.materials.fuel.fact, percentage: dashboardData.materials.fuel.percent },
  ...
  return (
    <Box display={"flex"} flexDirection={"column"} gap={2} minHeight={"100%"}>
      ...
      <Box display={"flex"} gap={2} minHeight={"45%"}>
        ...
        <Box display={"flex"} flexDirection={"column"} gap={2} width={"45%"}>
          {/* Итого затраты */}
          <Box
            sx={{
              background: "#F9F9F9",
          ...
          >
            ...
            <Box p={2}>
              {/* Заголовки колонок */}
              <Box display="flex" >
                <Box sx={{ width: "30%", textAlign: "center", borderRight: "1px solid #d0d0d0", paddingRight: 1 }}>
                  <Typography variant="body2" sx={{ fontWeight: "bold", fontSize: "12px", paddingBottom: '10px' }}>Затраты</Typography>
                </Box>
                <Box sx={{ width: "40%", textAlign: "center", borderRight: "1px solid #d0d0d0", paddingRight: 1 }}>
                  <Typography variant="body2" sx={{ fontWeight: "bold", fontSize: "12px" }}>Всего</Typography>
                </Box>
                <Box sx={{ width: "30%", textAlign: "center" }}>
                  <Typography variant="body2" sx={{ fontWeight: "bold", fontSize: "12px" }}>На 1 га</Typography>
                </Box>
              </Box>
              
              {/* Строка "Плановые" */}
              <Box display="flex" >
                <Box sx={{ width: "30%", textAlign: "left", borderRight: "1px solid #d0d0d0", paddingRight: 1 }}>
                  <Typography variant="body2" sx={{ fontSize: "12px", paddingBottom: '10px' }}>Плановые</Typography>
                </Box>
                <Box sx={{ width: "40%", textAlign: "center", borderRight: "1px solid #d0d0d0", paddingRight: 1 }}>
                  <Typography  color="#62A65D" fontWeight={"bold"} variant="body2" sx={{ fontSize: "12px" }}>{formatNumber(totalCostsData.planned.total)}</Typography>
                </Box>
                <Box sx={{ width: "30%", textAlign: "center" }}>
                  <Typography  color="#62A65D" fontWeight={"bold"} variant="body2" sx={{ fontSize: "12px" }}>{formatNumber(totalCostsData.planned.perHa)}</Typography>
                </Box>
              </Box>
              ...
              <Box display="flex">
                ...
                <Box sx={{ width: "40%", textAlign: "center", borderRight: "1px solid #d0d0d0", paddingRight: 1 }}>
                  <Typography color="#62A65D" fontWeight={"bold"} variant="body2" sx={{ fontSize: "12px" }}>
          ...
          >
            ...
            <Box p={2}>
              ...
              <Box display="flex" >
                <Box sx={{ width: "30%", textAlign: "center", borderRight: "1px solid #d0d0d0", paddingRight: 1 }}>
                  <Typography variant="body2" sx={{ fontWeight: "bold", fontSize: "12px", paddingBottom: '10px' }}>Продукция</Typography>
                </Box>
                <Box sx={{ width: "40%", textAlign: "center", borderRight: "1px solid #d0d0d0", paddingRight: 1 }}>
                  <Typography variant="body2" sx={{ fontWeight: "bold", fontSize: "12px" }}>Всего</Typography>
                </Box>
                <Box sx={{ width: "30%", textAlign: "center" }}>
                  <Typography variant="body2" sx={{ fontWeight: "bold", fontSize: "12px" }}>Ц/га</Typography>
                </Box>
              </Box>
              ...
              <Box display="flex" >
                ...
                <Box sx={{ width: "40%", textAlign: "center", borderRight: "1px solid #d0d0d0", paddingRight: 1 }}>
                  <Typography  color="#62A65D" fontWeight={"bold"} variant="body2" sx={{ fontSize: "12px" }}>{formatNumber(grossOutputData.planned.total)}</Typography>
                </Box>
                <Box sx={{ width: "30%", textAlign: "center" }}>
                  <Typography  color="#62A65D" fontWeight={"bold"} variant="body2" sx={{ fontSize: "12px" }}>{grossOutputData.planned.perHa}</Typography>
                </Box>
              </Box>
        ...
        <Box width={"55%"}>
          ...
          >
            ...
            <Box p={2}>
              {/* Заголовки колонок */}
              <Box display="flex" >
                <Box sx={{ width: "26%", textAlign: "center", borderRight: "1px solid #d0d0d0", paddingRight: 1 }}>
                  <Typography variant="body2" sx={{ fontWeight: "bold", fontSize: "12px", paddingBottom: '10px' }}>Затраты</Typography>
                </Box>
                <Box sx={{ width: "32%", textAlign: "center", borderRight: "1px solid #d0d0d0", paddingRight: 1 }}>
                  <Typography variant="body2" sx={{ fontWeight: "bold", fontSize: "12px" }}>План</Typography>
                </Box>
                <Box sx={{ width: "42%", textAlign: "center" }}>
                  <Typography variant="body2" sx={{ fontWeight: "bold", fontSize: "12px" }}>Факт</Typography>
                </Box>
              </Box>
              ...
              {materialCostsData.map((item, index) => (
                <Box key={index} display="flex" >
                  <Box sx={{ width: "26%", textAlign: "left", borderRight: "1px solid #d0d0d0", paddingRight: 1 }}>
                    <Typography variant="body2" sx={{ fontSize: "12px", paddingBottom: index < materialCostsData.length - 1 ? '10px' : '0px' }}>
                      {item.category}
                    </Typography>
                  </Box>
                  <Box sx={{ width: "32%", textAlign: "center", borderRight: "1px solid #d0d0d0", paddingRight: 1 }}>
                  ...
                  <Box sx={{ width: "42%", textAlign: "center", display: "flex", justifyContent: "space-around" }}>
                    <Typography color={item.percentage < 100 ? "#FF0000" : "#62A65D"} fontWeight={"bold"} variant="body2" sx={{ fontSize: "12px" }}>
                      {formatNumber(item.fact)}
                    </Typography>
                    <Typography color="#00BCE5" variant="body2" sx={{ fontSize: "10px", marginTop: "2px" }}>
                      {item.percentage}%
                    </Typography>
                  </Box>
                </Box>
      ...
      >
        ...
        <Box sx={{ padding: "16px", height: "400px", position: "relative" }}>
        <BarChart
  height={400}
  margin={{
    left: 10,
        ...
        >
          ...
          <Box sx={{ p: 3, pb: 2, borderBottom: '1px solid #e0e0e0' }}>
            <Typography id="modal-title" variant="h6" component="h2">
              Детали по категории: {detailsData?.summary?.group || selectedCategory?.name}
            </Typography>
          </Box>
          ...
          <Box sx={{ 
            ...
            {loading ? (
              <Box sx={{ mb: 2, textAlign: 'center', flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                {detailsData && (
                  <Box sx={{ mb: 2 }}>
                    <Typography variant="h6" sx={{ mb: 2 }}>
                      Детали по категории: {selectedCategory?.name}
                    </Typography>
                    
                    {/* Таблица в стиле референса */}
                    <TableContainer component={Paper} sx={{ boxShadow: 'none', border: '1px solid #d0d0d0' }}>
                      <Table size="small">
                        <TableHead>
                          <TableRow>
                            <TableCell 
